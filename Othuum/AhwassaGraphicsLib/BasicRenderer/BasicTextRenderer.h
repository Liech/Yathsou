...
namespace Ahwassa {
  ...
  public:
    ...
    void      start();
    void      end();
    void      drawText(std::string text, float x, float y, float scale, Iyathuum::Color color);
    void      drawText(std::string text, glm::vec2 pos, float scale, Iyathuum::Color color);
